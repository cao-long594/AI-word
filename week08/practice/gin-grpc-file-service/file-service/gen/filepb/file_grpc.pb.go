...
type FileServiceClient interface {
	SaveFile(ctx context.Context, in *SaveFileRequest, opts ...grpc.CallOption) (*FileInfo, error)
...
func (c *fileServiceClient) SaveFile(ctx context.Context, in *SaveFileRequest, opts ...grpc.CallOption) (*FileInfo, error) {
...
type FileServiceServer interface {
	SaveFile(context.Context, *SaveFileRequest) (*FileInfo, error)
...
func (UnimplementedFileServiceServer) SaveFile(context.Context, *SaveFileRequest) (*FileInfo, error) {
